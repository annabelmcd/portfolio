    ...
    return (
        <div>
            ...
            <div className="work-section">
                ...
                <Link to='/portfolio/work/PathwaysForward' className="project-card-small">
                ...
                <Link to='/portfolio/work/PathwaysForward' className="project-card-lg">
                    <img src="/img/PathwaysForward-Banner.png" /> 
                    <div className="break"></div>
                    <h3>Pathways Forward</h3>
                    <div className="break"></div>
                ...
                <Link to='/portfolio/work/ChoreSync' className="project-card-small">
                    <h3>ChoreSync</h3>
                    <div className="break"></div>
                ...
                <Link to='/portfolio/work/ChoreSync' className="project-card-lg">
                    <img src="/img/ChoreSync-Banner.png" /> 
                    <div className="break"></div>
                    <h3>ChoreSync</h3>
                    <div className="break"></div>
                ...
                <Link to='/portfolio/work/OtterWise' className="project-card-small">
                    <h3>OtterWise</h3>
                    <div className="break"></div>
                ...
                <Link to='/portfolio/work/OtterWise' className="project-card-lg">
                    <img src="/img/OtterWise-Banner.png" /> 
                    <div className="break"></div>
                    <h3>OtterWise</h3>
                    <div className="break"></div>
                ...
                <Link to='/portfolio/work/HuskyCommuter' className="project-card-small">
                    <h3>HuskyCommuter</h3>
                    <div className="break"></div>
                ...
                <Link to='/portfolio/work/HuskyCommuter' className="project-card-lg">
                    <img src="/img/HuskyCommuter-Banner.png" /> 
                    <div className="break"></div>
                    <h3>HuskyCommuter</h3>
                    <div className="break"></div>
